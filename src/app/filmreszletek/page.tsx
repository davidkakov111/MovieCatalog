...
const FilmReszletekContent: React.FC<{ filmDetails: any }> = ({ filmDetails }) => {
  ...
  return (
    <div className="max-w-2xl mx-auto mt-8 p-4 bg-gray-100 rounded-md">
      <h2 className="text-3xl font-bold mb-4 text-center text-gray-700">{film_adatok.cim}</h2>
  ...
  if (filmDetails !== null) {
    return (
      <Suspense fallback={<div>Betöltés...</div>}>
        <FilmReszletekContent filmDetails={filmDetails} />
      </Suspense>
    );
  } else {
